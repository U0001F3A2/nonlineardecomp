...
AliceResultLists, BobResultLists, AdversaryResultLists, resultList, AverageList;
	...
	for p in primes do
		...
		for i in [1..trials] do
			...
			PrintTo(Concatenation(DirectoryAnalysis,"results/",String(p),"_PreImages.txt"), resultList);
...
protocol(Filtered([37..60], IsPrime));
